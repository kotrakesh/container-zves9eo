...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zves9eo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zves9eo.containers.anotherwebservice.com/
...
```
git clone git@github.com:kotrakesh/container-zves9eo.git
cd container-zves9eo
```
...
```
docker attach container-zves9eo
```
